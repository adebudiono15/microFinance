...
@section('title', 'Filter Pendapatan Tunai'.' Dari '.date('d-m-Y', strtotime($awal)).' Sampai '.date('d-m-Y', strtotime($akhir)))
            ...
            <div class="row mt--2 justify-content-center">
                <div class="col-md-12">
                    <div class="card full-height">
                        <div class="card-body">
                         <div class="row">
                             <a href="{{ route('pendapatan-tunai') }}" class="btn btn-primary btn-sm ml-3 mb-3"> Kembali </a>
                         </div>
